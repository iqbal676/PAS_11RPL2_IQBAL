package com.example.iqbalmartono;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.apply();
                if (txtusername.getText().toString().equalsIgnoreCase("iqbal") && txtpassword.getText().toString().equals("iqbal")){
                    Intent in = new Intent(LoginActivity.this,MainMenuActivity.class);
                    Toast.makeText(LoginActivity.this, "Welcome iqbal", Toast.LENGTH_SHORT).show();
                    startActivity(in);
                    finish();
        ...
        tvforgot.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(LoginActivity.this, "Default username & password = iqbal", Toast.LENGTH_SHORT).show();
            }
        });
